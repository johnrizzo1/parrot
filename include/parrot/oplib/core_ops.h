...
op_lib_t *Parrot_DynOp_core_3_7_0(PARROT_INTERP, long init);
 ...
 opcode_t * Parrot_getattribute_i_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_i_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_i_p_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_i_p_pc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_i_p_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_i_p_pc_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_pc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_s_p_pc_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_p_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_pc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_p_sc(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_getattribute_n_p_pc_sc(opcode_t *, PARROT_INTERP);
 ...
 opcode_t * Parrot_setattribute_p_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_sc_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_s_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_sc_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_sc_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_s_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_sc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_s_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_s_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_sc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_sc_s(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_s_n(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_sc_n(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_s_n(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_s_n(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_p_sc_n(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_setattribute_p_pc_sc_n(opcode_t *, PARROT_INTERP);
