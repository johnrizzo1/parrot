...
op_lib_t *Parrot_DynOp_core_3_10_0(PARROT_INTERP, long init);
 ...
 opcode_t * Parrot_invoke_p_p_p(opcode_t *, PARROT_INTERP);
 ...
 opcode_t * Parrot_flatten_array_arg_p_p_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_flatten_array_arg_p_p_ic(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_flatten_hash_arg_p_p_i(opcode_t *, PARROT_INTERP);
 opcode_t * Parrot_flatten_hash_arg_p_p_ic(opcode_t *, PARROT_INTERP);
